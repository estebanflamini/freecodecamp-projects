...
ALTER TABLE ONLY public.elements
    ADD CONSTRAINT symbol_name_unique UNIQUE (name);


--
-- Name: elements symbol_unique_unique; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT symbol_unique_unique UNIQUE (symbol);
...
--
-- Name: properties properties_types_fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT properties_types_fk FOREIGN KEY (type_id) REFERENCES public.types(type_id);
